...
diag("Testing Hadouken::Base64 $Hadouken::Base64::VERSION, Perl $], $^X");
...
cmp_ok( decode_base64( encode_base64("foo") ), 'eq', "foo" );
...
sub encodeTest {
    ...
    for $test (@encode_tests) {
        ...
        cmp_ok( $encoded, 'eq', $expected );

        my $decoded = decode_base64($encoded);

        cmp_ok( $decoded, 'eq', $plain );
    }
} ## ---------- end sub encodeTest
